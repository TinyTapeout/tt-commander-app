// Source: https://github.com/thisbeyond/solid-select-site/blob/main/src/examples/suid-popper.tsx
// License: MIT License (from package.json), Copyright (c) 2022 Martin Pengelly-Phillips
...
export const Popper: ParentComponent<PopperProps> = (props) => {
  const [local, passthrough] = splitProps(props, ['open', 'anchorEl', 'placement', 'children']);
